...
import { X, Upload, Calendar, Coins, Users, Tag, Image, Camera } from 'lucide-react'
...
const CreateQuestModal: React.FC<CreateQuestModalProps> = ({ onClose, onSubmit }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const questData: Omit<Quest, 'id' | 'submissions' | 'status'> = {
      ...
      imageUrl: formData.imageUrl || 'https://images.unsplash.com/photo-1606983340126-99ab4feaa64a?w=400&h=300&fit=crop',
